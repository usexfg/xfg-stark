 ...
 * @dev Initial 4 tiers (2 amounts × 2 terms):
 ...
 *      Tier 2: 800 XFG × 3mo  @ 33% APY
 *      Tier 3: 800 XFG × 12mo @ 69% APY
...
contract COLDDepositProofVerifier is Ownable, Pausable, ReentrancyGuard {
    ...
    /// @dev CD interest amounts per tier (initial 4 tiers: 2 amounts × 2 terms)
    ...
    // Tier 2: 800 XFG × 3mo @ 33% APY
    // (800 / 100,000) × 0.33 × 10^12 = 2,640,000,000 atomic units
     ...
     * @return tier2 Legacy CD amount for 800 XFG × 3mo
     * @return tier3 Legacy CD amount for 800 XFG × 12mo
     */
